<template>
  <section>
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="id" label="公告id" width="140" sortable>
      </el-table-column>
      <el-table-column prop="description" label="公告内容" width="300" sortable>
      </el-table-column>
      <el-table-column prop="createTime" label="创建时间" min-width="110" sortable>
      </el-table-column>
      <el-table-column prop="createTime" label="结束时间" min-width="110" sortable>
      </el-table-column>
